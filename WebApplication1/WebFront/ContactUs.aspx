...
<head>
    ...
    <style type="text/css">
        ...
        .btn_submit
        {
            background-color: RGB(55, 185, 248);
            width: 60px;
            padding-left: 10px;
            height: 30px;
            line-height: 30px;
                    ...
                    <div id="msg_form" class="easyui-panel" title="留言" style="width: 230px; padding: 10px;">
                        <table>
                            <tr>
                                ...
                                <td class="tdright">
                                    <input id="email" type="text" class="area_text" />
                                </td>
                            </tr>
                            <tr>
                                <td class="tdleft">
                                ...
                                <td class="tdright">
                                    <textarea id="msg" class="area" cols="20"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <input type="submit" onclick="LeaveMessage()" value="提交" class="btn_submit" />
                                </td>
                            </tr>
                            <tr class="row_height">
                                <td colspan="2" id="error" style="text-align: center; color: red; font: 100">
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.state == "error") {
                        ...
                        alert("谢谢您的留言。我们会尽快回复您，请注意查看您的邮箱！");
                    }
                }
            })
        }
